 ...
 */
public class SpillableTimeStateTestUtils
{
  ...
  private SpillableTimeStateTestUtils()
  {
  ...
  {
    public ManagedTimeStateSpillableStore store;
    ...
    protected void starting(Description description)
    {
      ...
      ((FileAccessFSImpl)store.getFileAccess()).setBasePath(applicationPath + "/" + "time_bucket_data");
  ...
  public static void checkValue(SpillableTimeStateStore store, long bucketId,
  ...
  public static void checkOutOfBounds(SpillableTimeSlicedArrayListImpl<String> list, int index)
  {
