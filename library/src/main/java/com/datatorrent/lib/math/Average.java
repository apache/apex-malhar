 ...
 * </tr>
 * <tr>
 * <td><b>&gt; 175 Million tuples/s</b></td>
 * <td>Average value of tuples per window per port</td>
 * <td>In-bound rate is the main determinant of performance. Tuples are assumed
 * to be immutable. If you use mutable tuples and have lots of keys, the
 * benchmarks may be lower.</td>
 * </tr>
 * </table>
 * <br>
 * <p>
 ...
 * <th colspan=3>Out-bound (emit)</th>
 * </tr>
 * <tr>
 * <th><i>data</i>(V)</th>
 * <th><i>average</i>(V)</th>
