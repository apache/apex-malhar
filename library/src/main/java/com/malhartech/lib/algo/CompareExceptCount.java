 ...
 * <table border="1" cellspacing=1 cellpadding=1 summary="Benchmark table for CompareExceptCount&lt;K,V extends Number&gt; operator template">
 ...
 * <table border="1" cellspacing=1 cellpadding=1 summary="Function table for CompareExceptCount&lt;K,V extends Number&gt; operator template">
 * <tr><th rowspan=2>Tuple Type (api)</th><th>In-bound (process)</th><th colspan=2>Out-bound (emit)</th></tr>
 * <tr><th><i>data</i>(HashMap&lt;K,V&gt;)</th><th><i>count</i>(Integer)</th><th><i>except</i>(Integer)</th></tr>
 ...
 * <br>
 */
public class CompareExceptCount<K, V extends Number> extends Match<K, V>
{
