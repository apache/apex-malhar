...
/**
 *
 * Performance tests for {@link com.malhartech.lib.algo.MatchString}<p>
 *
 */
public class MatchStringBenchmark
{
  private static Logger log = LoggerFactory.getLogger(MatchStringBenchmark.class);
