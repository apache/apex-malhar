...
public class SpillableTimeSlicedArrayListMultiMapImplTest
{
  ...
  {
    setup();
    SpillableTimeSlicedArrayListMultiMapImpl<String, String> map =
        new SpillableTimeSlicedArrayListMultiMapImpl<String, String>(store, ID1, new StringSerde(), new StringSerde(), ke);
  ...
  public long simpleMultiKeyTestHelper(SpillableTimeStateStore store,
      SpillableTimeSlicedArrayListMultiMapImpl<String, String> map, String key, long nextWindowId)
  {
    ...
    SpillableTimeStateTestUtils.checkValue(store, 0L,
        SliceUtils.concatenate(keyBytes, SpillableArrayListMultimapImpl.SIZE_KEY_SUFFIX), 8, 0, serdeInt);

    SpillableTimeStateTestUtils.checkValue(store, 0L, keyBytes, 0, Lists.<String>newArrayList("a", "a", "b", "c", "d", "e",
        "f", "g"));
    ...
    SpillableTimeStateTestUtils.checkValue(store, 0L, keyBytes, 0, Lists.<String>newArrayList("a", "111", "b", "222", "d", "333",
        "f", "g", "tt", "ab", "99", "444"));
  ...
  public void recoveryTestWithManagedState()
  {
    setup();
    SpillableTimeSlicedArrayListMultiMapImpl<String, String> map =
        new SpillableTimeSlicedArrayListMultiMapImpl<>(store, ID1, new StringSerde(), new StringSerde(), ke);
    ...
    SpillableTimeSlicedArrayListMultiMapImpl<String, String> clonedMap = KryoCloneUtils.cloneObject(map);
    ...
    SpillableTimeStateTestUtils.checkValue(store, 0L, keyBytes, 0, Lists.<String>newArrayList("a", "111", "b", "222", "d",
