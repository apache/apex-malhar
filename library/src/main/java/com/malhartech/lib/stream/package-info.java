 ...
 * <b>{@link com.malhartech.lib.stream.HashMapToKeyValPair}</b>: Takes a HashMap and emits its keys, keyvals, vals. Used for breaking up a HashMap ito objects (keys, vals, or key/val pairs)<br>
