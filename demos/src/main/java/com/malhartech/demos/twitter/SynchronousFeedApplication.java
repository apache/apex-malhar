 ...
 */
public class SynchronousFeedApplication implements ApplicationFactory
{
  private static final Logger logger = LoggerFactory.getLogger(SynchronousFeedApplication.class);
  ...
  public DAG getApplication(Configuration conf)
  {
    ...
    b.addStream("tweetStream")
            .setSource(twitterFeed.getOutput(TwitterSynchronousSampleInput.OPORT_STATUS))
