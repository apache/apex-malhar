...
public class KestrelInputOperatorTest
{
  ...
  public static final class TestStringRabbitMQInputOperator extends AbstractKestrelInputOperator
  {
  ...
  public void testDag() throws Exception
  {
    final int testNum = 3;
    DAG dag = new DAG();
    TestStringRabbitMQInputOperator consumer = dag.addOperator("Generator", TestStringRabbitMQInputOperator.class);
