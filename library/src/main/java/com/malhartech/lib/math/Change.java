 ...
 * <b>base</b>: expects HashMap&lt;K,V extends Number&gt;<br>
 ...
 * <table border="1" cellspacing=1 cellpadding=1 summary="Benchmark table for Change&lt;K,V extends Number&gt; operator template">
 ...
 * <table border="1" cellspacing=1 cellpadding=1 summary="Function table for Change&lt;K,V extends Number&gt; operator template">
 * <tr><th rowspan=2>Tuple Type (api)</th><th colspan=2>In-bound (<i>data</i>::process)</th><th colspan=2>Out-bound (emit)</th></tr>
 * <tr><th><i>data</i>(HashMap&lt;K,V&gt;)</th><th><i>base</i>(HashMap&lt;K,V&gt;&gt;)</th><th><i>change</i>(HashMap&lt;K,V&gt;&gt;(1))</th><th><i>percent</i>(HashMap&lt;K,Double&gt;&gt;(1))</th></tr>
 ...
 * <br>
 */
public class Change<K, V extends Number> extends BaseNumberKeyValueOperator<K, V>
{
  ...
  public final transient DefaultInputPort<HashMap<K, V>> base = new DefaultInputPort<HashMap<K, V>>(this)
  {
    /**
