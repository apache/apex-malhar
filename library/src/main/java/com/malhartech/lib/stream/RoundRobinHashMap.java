...
/**
 * Create a HashMap tuple from incoming tuples. If keys[] are set, then each incoming tuple is the value of the key (in-order) till all keys get a value.
 * Once all keys are assigned values, the tuple (HashMap) is emitted, the process of assigning values starts again<p>
 * This is a stateful operator<br>
 * <b>Port</b>:<br>
 ...
 * <tr><td><b>&gt; 16 million tuples/s</td><td>One tuple (HashMap) emitted for N (N=3) incoming tuples, where N is the number of keys</td>
 ...
 * <tr><td>Data (process())</td><td>2</td><td>N/A</td></tr>
 * <tr><td>Data (process())</td><td>-1</td><td>N/A</td></tr>
