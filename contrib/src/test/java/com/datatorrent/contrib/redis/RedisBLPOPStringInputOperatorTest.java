...
/**
 *  Tests RedisBLPOPStringInputOperator for ability to correctly read strings from Redis.
 */
public class RedisBLPOPStringInputOperatorTest
{
  private String[] testData = new String[]{"123", "abc", "def"};
  private String redisKey = "RedisBLPOPStringInputOperatorTest";
  ...
  public void testInputOperator() throws InterruptedException {
    ...
    RedisBLPOPStringInputOperator input = new RedisBLPOPStringInputOperator();
    ...
    {
      Assert.assertEquals("value of "+ testData[i] + " == " + sink.collectedTuples.get(i), testData[i], sink.collectedTuples.get(i));
    }
  }
