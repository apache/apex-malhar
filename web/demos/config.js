...
settings.twitter.appName = 'TwitterTopCounterApplication';
...
settings.mobile.appName = 'MobileApplication';
settings.machine.appName = 'MachineData';
...
settings.dimensions.appName = 'AdsDimension';
...
settings.fraud.appName = 'FraudDetection';
