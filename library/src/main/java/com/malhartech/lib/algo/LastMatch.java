 ...
 * <table border="1" cellspacing=1 cellpadding=1 summary="Benchmark table for LastMatch&lt;K,V extends Number&gt; operator template">
 ...
 * <table border="1" cellspacing=1 cellpadding=1 summary="Function table for LastMatch&lt;K,V extends Number&gt; operator template">
...
public class LastMatch<K, V extends Number> extends BaseMatchOperator<K,V>
{
  ...
  protected transient HashMap<K, V> ltuple = null;
