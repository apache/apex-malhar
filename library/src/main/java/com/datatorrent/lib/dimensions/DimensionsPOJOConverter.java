...
public class DimensionsPOJOConverter implements Converter<Object, DimensionsEvent, DimensionsConversionContext>
{
  ...
  @Override
  public DimensionsEvent convert(Object inputEvent, DimensionsConversionContext context)
  {
    ...
    return new DimensionsEvent(key,
                              aggregates,
                              context.schemaID,
