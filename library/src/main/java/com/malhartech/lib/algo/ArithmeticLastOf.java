...
@ModuleAnnotation(
        ports = {
  @PortAnnotation(name = ArithmeticLastOf.IPORT_DATA, type = PortAnnotation.PortType.INPUT),
  @PortAnnotation(name = ArithmeticLastOf.OPORT_LASTOF, type = PortAnnotation.PortType.OUTPUT)
})
public class ArithmeticLastOf extends AbstractModule
{
