...
public class TwitterTopMediaTypesApplication implements StreamingApplication
{
  ...
  public void populateDAG(DAG dag, Configuration conf)
  {
    ...
    TwitterStatusMediaTypeExtractor MediaTypeExtractor = dag.addOperator(
        "WordExtractor", TwitterStatusMediaTypeExtractor.class);
    ...
    dag.addStream("TweetStream", twitterFeed.mediaType,
        MediaTypeExtractor.input);
    dag.addStream("TwittedWords", MediaTypeExtractor.output, uniqueCounter.data);
