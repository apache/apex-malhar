...
public class UserUpsertOperator extends AbstractUpsertOutputOperator
{
  ...
  public Map<String, TypeCodec> getCodecsForUserDefinedTypes()
  {
    ...
    UserType addressType = cluster.getMetadata().getKeyspace(keyspaceName).getUserType("address");
    ...
    UserType userFullNameType = cluster.getMetadata().getKeyspace(keyspaceName).getUserType("fullname");
