...
@ModuleAnnotation(
        ports = {
  @PortAnnotation(name = OrderByKeyDesc.IPORT_DATA, type = PortAnnotation.PortType.INPUT),
  @PortAnnotation(name = OrderByKeyDesc.OPORT_OUT_DATA, type = PortAnnotation.PortType.OUTPUT)
})
public class OrderByKeyDesc extends AbstractModule
{
  private static Logger LOG = LoggerFactory.getLogger(OrderByKeyDesc.class);
