 ...
 * <table border="1" cellspacing=1 cellpadding=1 summary="Benchmark table for CompareString&lt;K,String&gt; operator template">
 * <tr><th>In-Bound</th><th>Out-bound</th><th>Comments</th></tr>
 * <tr><td><b>8 Million K,String pairs/s</td><td>Each not matched tuple is emitted</td><td>In-bound rate and number of tuples that do not match determine performance.
 ...
 * <table border="1" cellspacing=1 cellpadding=1 summary="Function table for CompareString&lt;K,String&gt; operator template">
 * <tr><th rowspan=2>Tuple Type (api)</th><th>In-bound (process)</th><th>Out-bound (emit)</th></tr>
 * <tr><th><i>data</i>(HashMap&lt;K,String&gt;)</th><th><i>compare</i>(HashMap&lt;K,String&gt;)</th></tr>
