...
public class AffixKeyValueSerdeManager<K, V> extends KeyValueSerdeManager<K, V>
{
   ...
   */
  protected AffixSerde<K> metaKeySerde;
  protected AffixSerde<K> dataKeySerde;


  protected AffixKeyValueSerdeManager()
  {
    //for kyro
  }
  ...
  public V deserializeValue(byte[] buffer, MutableInt offset, int length)
  {
    return valueSerde.deserialize(buffer, offset, length);
  }
}
