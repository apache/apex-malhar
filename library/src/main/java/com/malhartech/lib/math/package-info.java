 ...
 * <b>{@link com.malhartech.lib.math.BaseNumberKeyOperator}</b>: Base class for operators that take in K,V extends Number. Provides basic methods for value conversion and key cloning<br>
