...
exports = module.exports = [
    ...
    { id: 'tuplesProcessedPSMA', label: DT.lang('processed_per_sec'), key: 'tuplesProcessedPSMA', format: 'commaInt', sort: 'number', filter: 'number' },
    { id: 'totalTuplesProcessed', label: DT.lang('processed_total'), key: 'totalTuplesProcessed', format: 'commaInt', sort: 'number', filter: 'number' },
    { id: 'tuplesEmittedPSMA', label: DT.lang('emitted_per_sec'), key: 'tuplesEmittedPSMA', format: 'commaInt', sort: 'number', filter: 'number' },
    { id: 'totalTuplesEmitted', label: DT.lang('emitted_total'), key: 'totalTuplesEmitted', format: 'commaInt', sort: 'number', filter: 'number' },
