...
public class AppDataTabularServerPojoTest
{
  @Test
  public void simpleTest() throws Exception
  {
    String query = SchemaUtils.jarResourceFileToString("tabularServerPojoQuery.json");
    String schema = SchemaUtils.jarResourceFileToString("tabularServerPojoSchema.json");
    ...
    AppDataTabularServerPOJO tabularServer = new AppDataTabularServerPOJO();
    tabularServer.setFieldToGetter(fieldToGetter);
    tabularServer.setTabularSchemaJSON(schema);

    CollectorTestSink<String> resultSink = new CollectorTestSink<String>();
    TestUtils.setSink(tabularServer.queryResult, resultSink);
    ...
    tabularServer.input.put(inputList);
    ...
    JSONObject data = new JSONObject(result).getJSONArray(DataQueryTabular.FIELD_DATA).getJSONObject(0);
  ...
  private static final Logger LOG = LoggerFactory.getLogger(AppDataTabularServerPojoTest.class);
}
