...
public class ColumnFilteringInterceptorTest
{
  ...
  public void testIntercept_Event()
  {
    ...
    builder.configure(new Context(getContext()));
  ...
  public void testFiles() throws IOException, URISyntaxException
  {
    ...
    for (Entry<Object, Object> entry : properties.entrySet()) {
      ...
      if (ColumnFilteringInterceptor.Builder.class.getName().equals(entry.getValue().toString())) {
    ...
    assertNotNull(ColumnFilteringInterceptor.Builder.class.getName(), interceptor);
  ...
  private static final Logger logger = LoggerFactory.getLogger(ColumnFilteringInterceptorTest.class);
}
