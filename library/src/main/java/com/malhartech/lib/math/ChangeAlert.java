 ...
 * <table border="1" cellspacing=1 cellpadding=1 summary="Benchmark table for ChangeAlert&lt;K,V extends Number&gt; operator template">
 ...
 * <table border="1" cellspacing=1 cellpadding=1 summary="Function table for ChangeAlert&lt;K,V extends Number&gt; operator template">
 * <tr><th rowspan=2>Tuple Type (api)</th><th>In-bound (<i>data</i>::process)</th><th>Out-bound (emit)</th></tr>
 * <tr><th><i>data</i>(HashMap&lt;K,V&gt;)</th><th><i>alert</i>(HashMap&lt;K,HashMap&lt;V,Double&gt;&gt;(1))</th></tr>
