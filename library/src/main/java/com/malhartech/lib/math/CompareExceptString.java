 ...
 * <table border="1" cellspacing=1 cellpadding=1 summary="Benchmark table for CompareExceptString&lt;K,V extends Number&gt; operator template">
 ...
 * <table border="1" cellspacing=1 cellpadding=1 summary="Function table for CompareExceptString&lt;K,V extends Number&gt; operator template">
 * <tr><th rowspan=2>Tuple Type (api)</th><th>In-bound (process)</th><th colspan=2>Out-bound (emit)</th></tr>
 * <tr><th><i>data</i>(HashMap&lt;K,String&gt;)</th><th><i>compare</i>(HashMap&lt;K,String&gt;)</th><th><i>except</i>(HashMap&lt;K,String&gt;)</th></tr>
