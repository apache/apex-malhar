...
public class XmlKeyValueStringCartesianProductTest
{
  ...
  {
    String xml = "<a><b><c><d>vd1</d><e>ve1</e></c><f>vf1</f></b><g>vg1</g><h>vh1</h></a>";
    String config = "a/b/c/d,a/b/c/e:a/b/f,a/g|a/b/c/e,a/g:a/b/f,a/h";
    List<String> collectedTuples = testOperator(xml, config);
    ...
    Assert.assertEquals("Output 2", "e=ve1,h=vh1", collectedTuples.get(5));
    Assert.assertEquals("Output 3", "g=vg1,f=vf1", collectedTuples.get(6));
    Assert.assertEquals("Output 4", "g=vg1,h=vh1", collectedTuples.get(7));
  }
