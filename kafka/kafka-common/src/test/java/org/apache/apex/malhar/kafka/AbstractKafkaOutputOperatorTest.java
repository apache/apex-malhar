...
public abstract class AbstractKafkaOutputOperatorTest
{
      ...
      boolean differentTuplesAfterRecovery) throws InterruptedException
  {
    ...
    if (exactlyOnce) {
      AbstractKafkaExactlyOnceOutputOperator<Person> kafkaOutputTemp =
  ...
  public abstract AbstractKafkaExactlyOnceOutputOperator<Person> createExaactlyOnceOutputOperator();

  public abstract AbstractKafkaInputOperator createKafkaInputOperator(DAG dag, DefaultInputPort inputPort);

  private AbstractKafkaExactlyOnceOutputOperator<Person> ResetKafkaOutput(
      String testName, Properties props, OperatorContext operatorContext)
  {
    AbstractKafkaExactlyOnceOutputOperator<Person> kafkaOutput = createExaactlyOnceOutputOperator();
