 ...
 */
public class EventClassifierBenchmark
{
  private static Logger log = LoggerFactory.getLogger(EventClassifierBenchmark.class);
  ...
  public void testNodeProcessing() throws Exception
  {
    ...
    log.info(String.format("\nThe number of keys in %d tuples are %d and %d",
                           ...
                           classifySink.collectedTupleValues.size()));
    Assert.assertEquals("number emitted tuples", sentval, ival);
    log.debug(String.format("\nBenchmarked %d tuples", numTuples * 12));
  }
}
