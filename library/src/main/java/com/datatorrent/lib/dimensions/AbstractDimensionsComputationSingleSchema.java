...
import com.datatorrent.lib.appdata.ns.DimensionsEvent.InputEvent;
...
public abstract class AbstractDimensionsComputationSingleSchema<INPUT_EVENT> extends com.datatorrent.lib.statistics.DimensionsComputation<InputAggrInputEventnsEventt>
{
  public static final int DEFAULT_SCHEMA_ID = 1;

  @NotNull
  private AggregatorRegistry aggregatorInfo;
  private transient List<InputAggregateEvenInputEventffer = Lists.newArrayList();
  @NotNull
  ...
  public void setup(OperatorContext context)
  {
    ...
    for(int ddID = 0;
      ...
      for(int aggIDIndex = 0;
        ...
        aggregatorList.add(
        new DimensionsComputationAggregator(aggregatorInfo.getIncrementalAggregatorIDToAggregator().get(aggIDIndex),
                                            outputDescriptor));
      }
    }
  ...
  public void processRawInput(INPUT_EVENT inputEvent)
  {
    ...
    for(int ddID = 0;
      ...
      for(int aggIDIndex = 0;
        ...
        InputAggregateEvent inputAgInputEvent    convertInputEvent(inputEvent, conversionContext);
  ...
  @Override
  public void processInputTuple(InputAggregateEvent inputAggregateEvInputEventw UnsupportedOperationException("The data input port should not be connected on this operator.");
  }

  public abstract InputAggregateEvent convertInputEvent(INPUT_EInputEventmensionsConversionContext context);

  @Override
  public void setAggregators(Aggregator<InputAggregateEvent, com.datatorrent.lib.appdata.dimenInputEventnt>[] aggregators)
  {
    throw new UnsupportedOperationException("This method is not supported.");
  }

  @Override
  public Aggregator<InputAggregateEvent, com.datatorrent.lib.appdata.dimensioDimensInputEventAggregators()
  {
    throw new UnsupportedOperationException("This method is not supported.");
  }
