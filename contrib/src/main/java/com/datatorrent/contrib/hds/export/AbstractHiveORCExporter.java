 ...
 */
public abstract class AbstractHiveORCExporter<EVENT> extends AbstractHDSFileExporter<EVENT> {

  AbstractHiveORCExporter(HDSCodec<EVENT> codec) {
    super(codec);
  }
