...
/**
 *
 * Takes in one stream via input port "data". Occurance of each key is counted and at the end of window the least frequent key is emitted on output port "count"<p>
