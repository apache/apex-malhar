 ...
 * passed the test, it is emitted on the output port "out_data". The comparison is done by getting double value from the Number.<p>
 *  * This module is a pass through<br>
 * <br>
 * Ports:<br>
 * <b>in_data</b>: Input port, expects HashMap<String, Object><br>
 * <b>out_data</b>: Output port, emits HashMap<String, Object><br>
 * <br>
 * Properties:<br>
...
@ModuleAnnotation(
  ...
  @PortAnnotation(name = ArithmeticCompare.OPORT_OUT_DATA, type = PortAnnotation.PortType.OUTPUT)
})
