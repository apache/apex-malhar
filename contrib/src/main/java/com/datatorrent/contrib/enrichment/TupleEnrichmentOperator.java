 ...
 *
 * @displayName TupleEnrichment
 * @category Database
 * @tags enrichment, pojo, schema, lookup
 * @since 3.1.0
 */
public class TupleEnrichmentOperator extends AbstractEnrichmentOperator<Object, Object> implements ActivationListener<Context>
{
  private static final Logger log = LoggerFactory.getLogger(TupleEnrichmentOperator.class);
  ...
  public transient DefaultInputPort<Object> inputPojo = new DefaultInputPort<Object>() {
    ...
    {
      TupleEnrichmentOperator.this.input.put(tuple);
    }
  };
  ...
  public TupleEnrichmentOperator()
  {
    includeFieldsStr = "";
    lookupFieldsStr = "";
  }
