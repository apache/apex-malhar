...
/**
 *
 * Performance tests for {@link com.datatorrent.lib.algo.LastMatchStringMap}<p>
 *
 */
public class LastMatchStringMapBenchmark
{
  private static Logger log = LoggerFactory.getLogger(LastMatchStringMapBenchmark.class);
